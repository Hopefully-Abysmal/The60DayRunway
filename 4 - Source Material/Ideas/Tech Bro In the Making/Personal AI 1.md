...
# Me
Back to writing a proposal, can you help me formulate it for potential investors? Leave out the money; I want this to be a non-profit such that it can allow for people to stay afloat in a world of post-labor economics (allowing everyone access to a baseline intellegence to be trained to be their own personal assistant / extension of their intellect and prowess.) Ideally everyone would train these ais and when they die they contribute that training to one central database that can allow people to continue the growth based on their chosen intellegence model (for productivity, creativity etc.). Allow for generational wealth by the training of the kids of users to access the nuances of the model (perhaps through documentation and the proprietary information referenced) and transferring the physical hardware associated with it.
...
# Me
Yapped with mason for a bit, he brought up some good counterpoints: Pseudo-entrepreneurship, energy consumption, and the market adjustment to productivity squeezing; "diamond encrusting the golden handcuffs". Food for thought; I dont want to know what I want to give the world but this is what it seems to be asking me for.
>>>>>>> branch 'main' of https://github.com/lardahle/Zettelkasten
